...
async function growthAdmin(){
  try{
    ...
    const lr=await fetch(SUPABASE_URL+'/rest/v1/growth_point_transactions?select=*&order=created_at.desc&limit=200',{headers:auth()}); growthLogs=lr.ok?await lr.json():[]; renderGrowthLogs();
