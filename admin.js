...
async function settleCompetition(){
  ...
  msg('competitionMsg',d.already?'ℹ️ 此活動已結算。':'🏁 活動結算完成：完成 '+(d.completed||0)+' 人、未到 '+(d.no_show||0)+' 人、完成積分 '+(d.completion_points||0)+'。');await loadCompetitionAttendance(id);await competitions();
}
