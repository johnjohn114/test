...
const growthAchievementTypeNames={registration_count:'報名次數',result_place:'名次成績',points:'累積積分'};
...
async function saveGrowthReward(){
  ...
  const body={code,title,description,icon,reward_type:'coupon',point_cost,min_level,required_achievement_id,user_limit,total_limit,coupon_title,coupon_description,coupon_discount,coupon_expires_days,sort_order,enabled};
